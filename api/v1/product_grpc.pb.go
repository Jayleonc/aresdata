...
type ProductServiceClient interface {
	...
	// 查询单个商品信息
	GetProduct(ctx context.Context, in *ProductQueryRequest, opts ...grpc.CallOption) (*ProductQueryResponse, error)
}
...
func (c *productServiceClient) GetProduct(ctx context.Context, in *ProductQueryRequest, opts ...grpc.CallOption) (*ProductQueryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductQueryResponse)
...
func (UnimplementedProductServiceServer) GetProduct(context.Context, *ProductQueryRequest) (*ProductQueryResponse, error) {
...
func _ProductService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProduct(ctx, req.(*ProductQueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
