...
type VideoServiceClient interface {
	...
	// 查询单个视频信息
	GetVideo(ctx context.Context, in *VideoQueryRequest, opts ...grpc.CallOption) (*VideoQueryResponse, error)
}
...
func (c *videoServiceClient) GetVideo(ctx context.Context, in *VideoQueryRequest, opts ...grpc.CallOption) (*VideoQueryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VideoQueryResponse)
...
func (UnimplementedVideoServiceServer) GetVideo(context.Context, *VideoQueryRequest) (*VideoQueryResponse, error) {
...
func _VideoService_GetVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServiceServer).GetVideo(ctx, req.(*VideoQueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
