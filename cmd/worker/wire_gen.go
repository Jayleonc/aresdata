...
func wireApp(bootstrap *conf.Bootstrap, confData *conf.Data, logger log.Logger) (*App, func(), error) {
	...
	v := task.NewTaskSet(fetchVideoRankTask, processVideoRankTask, fetchVideoTrendTask, processVideoTrendTask, fetchVideoSummaryTask, processVideoSummaryTask, fetchVideoDetailsHeadlessTask, remedyVideoDetailsHeadlessTask, processVideoDetailHeadlessTask)
	app := newApp(logger, v)
	return app, func() {
		cleanup()
	}, nil
